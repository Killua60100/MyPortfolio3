...
(function($) {
	...
	$window.on('load', function() {
		...
		if (!bgElement) {
			console.error("L'élément #bg n'existe pas dans le DOM.");
			return;
		}
		
		// Code pour le fond d'écran aléatoire
		const images = [
		...
		document.getElementById('bg').style.backgroundImage = `url('${randomImage}')`;
